...
const ItemDom = ({ name, id, onRemove, children }) => (
	<div style={{
		...
		{children}
		<div style={{ textAlign: 'right', paddingBottom: 10, paddingTop: 20 }}>
...
module.exports = Field.create({
	...
	renderFieldsForItem (index, value) {
		return Object.keys(this.props.fields).map((fieldName) => {
			...
			props.mode = 'edit';
			const test = ((a, b) => a?`${a}[${b}]`:b)(this.props.inputNamePrefix, this.props.path);
			props.inputNamePrefix = `${test || this.props.path}[${index}]`;
